...
public class Activity_Main extends AppCompatActivity {
    ...
    RelativeLayout rellay_timeline, rellay_friends, rellay_chat, rellay_music,rellay_gallery, rellay_map, rellay_weather, rellay_settings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rellay_friends = (RelativeLayout) findViewById(R.id.rellay_friends);
        rellay_chat = (RelativeLayout) findViewById(R.id.rellay_chat);
        rellay_music = (RelativeLayout) findViewById(R.id.rellay_music);
        rellay_gallery = (RelativeLayout) findViewById(R.id.rellay_gallery);
        rellay_map = (RelativeLayout) findViewById(R.id.rellay_map);
        rellay_weather = (RelativeLayout) findViewById(R.id.rellay_weather);
